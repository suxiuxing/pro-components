...
| `shouldUpdate` | `boolean \| ((newValues: Record<string, any>, oldValues?: Record<string, any>) => boolean)`     | Fine-grained control over whether to render.<br /> If `true`, form items will automatically re-render.<br /> If `false`, form items will not update but can use [dependencies to trigger updates](#dependency-linkage).<br /> If `function`, it decides whether to re-render form items based on the return value |
| `title`        | `ReactNode`                                                                                     | Form title                                                                                                                                                                                                                                                                                                        |
| `action`       | `RefObject<ProCoreActionType \| undefined>`                                                     | Action for operating the form, supporting reload and other operations                                                                                                                                                                                                                                             |
| `formRef`      | `RefObject<ProFormInstance \| undefined>`                                                       | Get form instance, supports all methods of antd form                                                                                                                                                                                                                                                              |

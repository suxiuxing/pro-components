...
| submitter     | Submit button configurations in the same way as [ProForm](/components/form)                                                                    | [ProForm](/components/form)                       | -       |
...
| open          | whether to open                                                                                                                                  | `boolean`                                          | -       |
| resize        | Whether to allow drag resize. When set to `true`, default config will be used                                                                    | `{onResize,maxWidth,minWidth}` \| `boolean`        | `false` |
| onOpenChange  | trigger when open changes                                                                                                                        | `(open:boolean)=>void`                             | -       |
...
| width         | Width of the drawer (controlled, higher priority than `resize`)                                                                                  | `number`                                           | -       |

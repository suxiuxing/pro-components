...
| name               | 可编辑表格的 name，通过这个 name 可以直接与 form 通信，无需嵌套                                    | `NamePath`                                                                                                                                                                                                               | -                                                                   | -    |
...
> 请求远程数据比较复杂，详细可以看[这里](/components/schema#request-%E5%92%8C-params)。
...
| request                                | 从服务器请求枚举                                                                                                                                 | [request](/components/schema#request-%E5%92%8C-params)                                                              | -      |
